...
<html xmlns=   "http://www.w3.org/1999/xhtml"
    ...
    <head>
        ...
        <meta name="csrf-token" content="FhUzl7TYvXcAWisA8pOPOHJhcDevvu2ZXmHoQDM4" />
        <meta name="pageType"  value='WorkInfo' />

        <title>
           Work info: Work of the Holy Spirit -
...
<div id="book-summary" class="contentSection">
    ...
    <div class="d-flex flex-wrap w-100">
                                    <h5 class="flex-grow-1 mb-0"><a href="https://ccel.org/ccel/kuyper/holy_spirit/holy_spirit.i.html">
                    <button id="navbar_readOnline" class="btn text-light bg-light-hover no-animate">
                        Read Online
                    </button>
                </a></h5>
                                                <h5 class="flex-grow-1 mb-0"><a href="/ccel/k/kuyper/holy_spirit/cache/holy_spirit.pdf">
                    <button id="navbar_download" class="btn text-light bg-light-hover no-animate">
                        Download
                    </button>
                </a></h5>
                                                <h5 class="flex-grow-1 mb-0"><a href="https://ccel.org/ccel/kuyper/holy_spirit/holy_spirit/mp3">
    ...
    <div id="quick_summary" class="d-flex flex-wrap border border-0">
        <div style="vertical-align:top" class="pb-3 pr-3">
          <div id="biggerp">
            <a style="display:block" href="https://ccel.org/ccel/kuyper/holy_spirit/holy_spirit.i.html">
                <img alt="Read this book" title="Read this book" onerror="this.src='/img/unknown_book.png'"
                    src="https://ccel.org/ccel/kuyper/holy_spirit/files/holy_spirit-thumb.jpg" class="book-info-cover" />
        ...
        <div class="bookinfo_description p-0 col-sm-6">
          "Even though we honor the Father and
...
style="height: 25px;">
        ...
        <div class="mainMenuBar hoverShow">
            <ul class="menubar">
                    ...
                    <div class="text-center">
                        <a href="https://ccel.org/ccel/kuyper/holy_spirit/holy_spirit.i.html">
                            Read online
                        </a>
                    </div>
                    &#160;&#160;&#160;
                    <div class="dropdown-menu bg-secondary" style="top: 95%">
                              ...
                              href="https://ccel.org/ccel/kuyper/holy_spirit/holy_spirit.i.html">
                                  HTML
                            </a>
                                                    <a class="dropdown-item"
                              href="/ccel/kuyper/holy_spirit/Page_Index.html">
                    ...
                    <div class="text-center">
                        <a href="/ccel/k/kuyper/holy_spirit/cache/holy_spirit.epub">
                            Read on mobile
                        </a>
                    </div>
                    &#160;&#160;&#160;
                    <div class="dropdown-menu bg-secondary" style="top: 95%">
                                                    <a class="dropdown-item"
                              href="/ccel/k/kuyper/holy_spirit/cache/holy_spirit.epub">
                                  ePub
                            </a>
                                                    <a class="dropdown-item"
                              href="/ccel/k/kuyper/holy_spirit/cache/holy_spirit.epub">
                                  ePub for iPhone
                                                    ...
                                                    <a class="dropdown-item"
                              href="http://www.amazon.com/dp/B002M3SI2U">
                                  Kindle eBook
                            </a>
                                            </div>
                </li>
                    ...
                    <div class="text-center">
                        <a href="/ccel/k/kuyper/holy_spirit/cache/holy_spirit.pdf">
                            Download
                        </a>
                    </div>
                    &#160;&#160;&#160;
                    <div class="dropdown-menu bg-secondary" style="top: 95%">
                                                    <a class="dropdown-item"
                              href="/ccel/k/kuyper/holy_spirit/cache/holy_spirit.pdf">
                                  PDF
                            </a>
                                                    <a class="dropdown-item"
                              href="/ccel/k/kuyper/holy_spirit/cache/holy_spirit.doc">
                                  Microsoft Word html w/markup
                            </a>
                                                    <a class="dropdown-item"
                              href="/ccel/k/kuyper/holy_spirit/cache/holy_spirit.txt">
                                  Unicode Text (utf-8)
                            </a>
                                                    <a class="dropdown-item"
                              href="/ccel/k/kuyper/holy_spirit.xml">
    ...
    <div id="goodreads-widget">
        <div id="gr_header">
            <h1>
                <a rel="nofollow"
                    href="https://www.goodreads.com/book/isbn/B002M3SI2U?utm_medium=api&amp;utm_source=reviews_widget">
                    Goodreads reviews for Work of the Holy Spirit
                </a>
            </h1>
        </div>
        <iframe id="the_iframe" src="https://www.goodreads.com/api/reviews_widget_iframe?did=DEVELOPER_ID&amp;format=html&amp;header_text=Goodreads+reviews&amp;isbn=B002M3SI2U&amp;links=660&amp;review_back=fff&amp;stars=000&amp;text=000" frameborder="0">
        </iframe>
        <div id="gr_footer">
    ...
    <h2 style="margin-bottom:0pt;">About Abraham Kuyper</h2>
    <p><a href="/ccel/kuyper">View author page &raquo;</a></p>

    <div id="hiddenAuthorPicture">
        <img src="//staticccel.org/pix/person/kuyper.jpg"
            alt="Picture of Abraham Kuyper" />
        ...
        <tr>
            <td class="authorPicture" rowspan="5">
                ...
                <div class="citation">Source: Wikipedia</div>
                        ...
                        <td><b>Born: </b>October 29, 1837
                            </td>
                    </tr>
                <tr>
            <td><b>Died: </b>November 8, 1920
                            </td>
        </tr>
                <tr>
